...
const tiers: Record<string, Record<string, unknown>> = {
  pilot: {
    ...
    active: true,
    stripePriceId: "",
    perBenchPriceId: "<PILOT_PER_BENCH_STRIPE_PRICE_ID>",
    pricePerBench: 1200,
    annualPriceUsd: 14400,
    perBenchAnnualUsd: 14400,
    baseBenches: 1,
    includedActions: 0,
    overagePerAction: 0,
    features: [
  ...
  production: {
    ...
    active: true,
    stripePriceId: "",
    perBenchPriceId: "<PRODUCTION_PER_BENCH_STRIPE_PRICE_ID>",
    pricePerBench: 3200,
    annualPriceUsd: 38400,
    perBenchAnnualUsd: 38400,
    baseBenches: 1,
    includedActions: 0,
    overagePerAction: 0,
    features: [
  ...
  enterprise: {
    ...
    active: true,
    stripePriceId: "",
    perBenchPriceId: "<ENTERPRISE_PER_BENCH_STRIPE_PRICE_ID>",
    pricePerBench: 4800,
    annualPriceUsd: 57600,
    perBenchAnnualUsd: 57600,
    baseBenches: 1,
    includedActions: 0,
    overagePerAction: 0,
    features: [
