      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-4 text-muted max-w-2xl">
            Reality Anchors works alongside your detailing and ERP systems — turning plans into verified outcomes on the shop floor and feeding clean data back upstream.
          </p>
        </motion.div>
