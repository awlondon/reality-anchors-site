        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start">
          ...
          >
            ...
            <p className="text-muted leading-relaxed mb-8">
              {description || 'Fill out the form and we\'ll come back with a fit assessment, a suggested rollout scope, and an estimate of what you could save.'}
            </p>
            <ul className="flex flex-col gap-3">
              {[
                'Tailored walkthrough for your role — operations, engineering, or procurement.',
                'Savings estimate based on your material throughput and current scrap rates.',
