  ...
  const cards: CardData[] = [
    {
      ...
      metricSuffix: 'error-rate target after structured validation',
    },
    {
      icon: <ValidateIcon />,
      tag: 'VALIDATE',
      title: 'Catches problems before they leave the bench',
      body: 'The workflow starts with your job specs and operator-confirmed steps. The system verifies work automatically so problems get caught at the bench — not in the field.',
