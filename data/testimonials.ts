...
export const testimonials: Testimonial[] = [
  // ── Homepage (3 used: indices 0, 1, 3 of home-filtered list) ──
  {
    id: 'ops-manager-yard',
    quote:
      'Rework dropped 34% in the first quarter and scrap fell from 6.1% to 4.3%. The difference was catching bad cuts before they left the bench \u2014 not after they got to the field.',
  ...
  },
  {
    ...
    quote:
      'RFI volume dropped 41% in two months. My detailers were spending half their day chasing corrections \u2014 now the checks happen at the bench, so they can focus on production drawings.',
  ...
  },
  {
    ...
    quote:
      'Field rejections went from about twelve a month to two. We used to find tolerance issues when the piece didn\u2019t fit on site \u2014 now the operator catches it before the torch lights.',
  ...
  },
  {
    ...
    quote:
      'Three sites live in under four weeks, zero on-prem infrastructure, and a 7.2x ROI by the end of the first year. When I showed those numbers to the CFO, the conversation was already over.',
