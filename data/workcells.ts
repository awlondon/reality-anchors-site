...
export const workcells: Workcell[] = [
  {
    ...
    name: 'Rebar Cut & Bend',
    shortName: 'Rebar',
    tagline: 'Execution guidance for rebar cut and bend — start with one camera, expand when the workflow earns it.',
    description:
      'Execution guidance and validation for rebar fabrication. Start with one camera, expand coverage, and add precision depth only where it creates real value.',
    status: 'live',
    ...
    seoKeywords: [
      ...
      'fabrication execution guidance',
    ],
    ...
    metrics: [
      ...
      { value: 'Precision depth', label: 'Optional upgrade' },
    ...
    integrations: [
      ...
      'QA and audit export',
      'Equipment-aware job context',
    ],
    workflowSteps: [
      'Set up your job specs and start with one camera at the bench',
      'Add context cameras when coverage or throughput demands broader visibility',
      'Add precision depth devices only where they create real operational value',
