...
if (annualSavings < 15000) return "< $15k → $2k/year";
if (annualSavings < 50000) return "$15k–$50k → $6k/year";
if (annualSavings < 150000) return "$50k–$150k → $15k/year";
return "$150k+ → Custom";
}

function calculateSavings(params) {
const { tonsPerMonth, steelCostPerTon, segment, laborRate, hoursSavedPerTon } = params;
